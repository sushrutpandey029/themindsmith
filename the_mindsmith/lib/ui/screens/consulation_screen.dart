  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
          ...
          child:
              Consumer<NotificationProvider>(builder: (context, value, widget) {
            return ListView(
              children: [
                Material(
                  elevation: 10,
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Provider.of<NotificationProvider>(context,
                                  listen: false)
                              .selectAllotment(
                                  value.allotmentNotificationList.elementAt(i),
                                  context);
                        },
                        leading: const Icon(Icons.person),
                        title: Text(value.allotmentNotificationList
                            .elementAt(i)
                            .doctorName),
                        subtitle: Text(formateDate1(value
