...
class DoctorProfileWidget extends StatefulWidget {
   DoctorProfileWidget({ Key? key ,required this.doctorModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text('${widget.doctorModel.doctorExperience} Years of Expreince',style: text2,),
          ...
          Text(widget.doctorModel.doctorSpecialty,style: text2,),
          ...
          Text(widget.doctorModel.doctorQualification,style: text2,),
