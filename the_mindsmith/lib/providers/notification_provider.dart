...
class NotificationProvider extends ChangeNotifier {
  ...
  Future<void> fetchNotification(BuildContext context) async {
    ...
    isLoading = true;
    notifyListeners();
    String id = Provider.of<AuthProvider>(context,listen: false).userResponse!['users']['id']; //don't forget to check this when read user
  ...
  Future<void> selectAllotment(AllotmentNotificationModel allotment,BuildContext context) async {
