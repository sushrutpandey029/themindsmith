...
class ChatBoxWidget extends StatefulWidget {
  ChatBoxWidget({Key? key, required this.time, required this.message, required this.byUser,required this.isContinued})
      : super(key: key);
  String message;
  bool byUser;
  bool isContinued;
...
class _ChatBoxWidgetState extends State<ChatBoxWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:widget.isContinued?const EdgeInsets.only(left:50,right: 50): const EdgeInsets.only(top:16.0),
      child: Row(
        mainAxisAlignment:
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  color: widget.byUser?Colors.white:const Color.fromARGB(255, 223, 255, 232),
                  // border: Border.all(),
