...
class NotificationRepo {
  String _notificationApi = "$baseUrl/Notification_api_controller";
...
if(response.data['Alldocnotificaton']!=null) {
  ...
  // Future<List<AllotmentNotificationModel>> fetchAllotmentNotification(String userId) async {
  //     List<AllotmentNotificationModel> list = [];
  //     String url = "$_notificationApi/User_appointment_notification";

  //    Response response =
  //       await Dio().post(url, data: {"user_id": userId});
  //       // print(response.data);
